# GrowthSDK SDK 层级切换测试指南

## 🎯 测试目标

验证GrowthSDK SDK的层级切换功能是否正常工作，确保：
1. 广告检测时自动触发层级切换
...
```
[GrowthSDK] 📱 游戏视图显示
[GrowthSDK] 🎮 Unity加载状态: true
[GrowthSDK] ✅ Unity已加载完成，可以显示WebView
```
...
```
[GrowthSDK] 🔄 开始执行层级切换
[GrowthSDK] 🔄 切换到WebView层
[GrowthSDK] 🔄 切换WebView到顶层
[GrowthSDK] 🔝 顶层切换为: WebView
[GrowthSDK] 🔢 Unity zIndex: 10, WebView zIndex: 99
```
...
```
[GrowthSDK] 🔄 切换到游戏层
[GrowthSDK] 🔄 切换Unity到顶层
[GrowthSDK] 🔝 顶层切换为: Unity游戏
[GrowthSDK] 🔢 Unity zIndex: 99, WebView zIndex: 10
```
...
**排查步骤:**
1. 检查GrowthSDKLayerManager是否正确初始化
...
GrowthSDK SDK的层级切换功能测试通过，所有核心功能正常工作：
